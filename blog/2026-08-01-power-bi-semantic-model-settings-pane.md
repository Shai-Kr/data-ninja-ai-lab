...
.article-body img[src*="semantic-model-settings-pane"] { width: min(100%, 620px); max-width: 620px; display: block; margin-left: auto; margin-right: auto; }
.article-body table { display: block; overflow-x: auto; white-space: nowrap; }
</style>

![Semantic model settings control map]({{ '/assets/blog/semantic-model-settings-pane/01-settings-pane-control-map.svg' | relative_url }})
...
![Semantic model settings admin checklist]({{ '/assets/blog/semantic-model-settings-pane/02-admin-checklist.svg' | relative_url }})
...
![Semantic model settings operating model]({{ '/assets/blog/semantic-model-settings-pane/03-operating-model.svg' | relative_url }})
